...
### [Archgate](https://archgate.dev) — Executable Architecture Decision Records
...
|-----------|-------------|
| [**CLI**](https://github.com/archgate/cli) | Free & open-source CLI for managing ADRs and running automated checks (Apache-2.0) |
| [**Editor Plugins**](https://archgate.dev) | AI governance for Claude Code, Cursor, VS Code / Copilot, and opencode |
| [**GitHub Actions**](https://github.com/archgate/check-action) | One-step CI integration — installs Archgate and runs checks with GitHub annotations |
| [**ADR Registry**](https://github.com/archgate/awesome-adrs) | Curated, importable ADR packs (TypeScript, testing, security, accessibility, Next.js, and more) |
| [**CLI Docs**](https://cli.archgate.dev) | Full command reference and rules authoring guide |
